...
// 분과(division)와 분과 버전(divisionVersion)은 UI 컨트롤이 없고 대시보드에서 링크로만 전달된다.
type Filters = { year: string; dept: string; category: string; type: string; track: string; division: string; divisionVersion: string; q: string };
